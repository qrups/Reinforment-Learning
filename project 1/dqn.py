...
class DQNAgent:
    ...
    def run(self, episodes=1000):
        ...
        for ep in range(episodes):
            ...
            if ep % 100 == 0:
                ...
                # drive path
                drive_path = os.path.join("/content/drive/MyDrive/lab 5/task 1", f"model_ep{ep}.pt")
            ...
            if ep % 20 == 0:
                ...
                if eval_reward > self.best_reward:
                    ...
                    torch.save(self.q_net.state_dict(), model_path)
                    # drive path
                    drive_path = os.path.join("/content/drive/MyDrive/lab 5/task 1", "best_model.pt")
                    torch.save(self.q_net.state_dict(), drive_path)
    ...
    def train(self):
        ...
        if len(self.memory) < self.replay_start_size:
            #print(f"len memory: {len(self.memory)}")
            return 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lr", type=float, default=0.00047)
